...
def greeting(name,greeting="Hello ",  excl="!"): # just switch the variable greething and name
...
c_false = checkingIfIn('pinaple')
# Call the fucntion so that it returns True and assign it to the variable c_true
c_true = checkingIfIn('pinaple', False)
# Call the function so that the value of fruit is assigned to the variable fruit_ans
fruit_ans= checkingIfIn('fruit')
# Call the function using the first and third parameter so that the value 8 is assigned to the variable param_check
param_check = checkingIfIn('apple', False, {'apple': 8, 'pear': 1, 'fruit': 19))
